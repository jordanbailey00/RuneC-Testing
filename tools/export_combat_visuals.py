...
def export_curated_special_rows(
    ...
    specials = [
        ("dragon_longsword", "any", "cleave", "sp_attack_cleave_spotanim",
         None, "rsmod:special:dragon_longsword"),
        ("dragon_dagger", "any", "puncture", None,
         None, "b237:special:dragon_dagger"),
        ("dragon_dagger_p", "any", "puncture", None,
         None, "b237:special:dragon_dagger_p"),
        ("dragon_dagger_p+", "any", "puncture", None,
         None, "b237:special:dragon_dagger_p+"),
        ("dragon_dagger_p++", "any", "puncture", None,
         None, "b237:special:dragon_dagger_p++"),
        ("abyssal_dagger", "any", "abyssal_dagger_special",
         "abyssal_dagger_special_spotanim", None,
         "b237:special:abyssal_dagger"),
        ("abyssal_dagger_p", "any", "abyssal_dagger_special",
         "abyssal_dagger_special_spotanim", None,
         "b237:special:abyssal_dagger_p"),
        ("abyssal_dagger_p+", "any", "abyssal_dagger_special",
         "abyssal_dagger_special_spotanim", None,
         "b237:special:abyssal_dagger_p+"),
        ("abyssal_dagger_p++", "any", "abyssal_dagger_special",
         "abyssal_dagger_special_spotanim", None,
         "b237:special:abyssal_dagger_p++"),
        ("granite_maul", "any", "slayer_granite_maul_special_attack",
         None, None, "b237:special:granite_maul"),
        ("granite_maul_pretty", "any", "slayer_granite_maul_special_attack",
         None, None, "b237:special:granite_maul_pretty"),
        ("granite_maul_plus", "any", "slayer_granite_maul_special_attack",
         None, None, "b237:special:granite_maul_plus"),
        ("granite_maul_pretty_plus", "any",
         "slayer_granite_maul_special_attack",
         None, None, "b237:special:granite_maul_pretty_plus"),
        ("dragon_claws", "any", "human_dragon_claws_spec",
         "dragon_claws_spot", None, "b237:special:dragon_claws"),
        ("br_dragon_claws", "any", "human_dragon_claws_spec",
         "dragon_claws_spot", None, "b237:special:br_dragon_claws"),
        ("bh_dragon_claws_corrupted", "any", "human_dragon_claws_spec",
         "dragon_claws_spot", None,
         "b237:special:bh_dragon_claws_corrupted"),
        ("deadman_blighted_dragon_claws", "any", "human_dragon_claws_spec",
         "dragon_claws_spot", None,
         "b237:special:deadman_blighted_dragon_claws"),
        ("dragon_warhammer", "any", "dragon_warhammer_sa_player",
         "dragon_warhammer_sa_spotanim", None,
         "b237:special:dragon_warhammer"),
        ("dragon_warhammer_ornament", "any", "dragon_warhammer_sa_player",
         "dragon_warhammer_sa_spotanim", None,
         "b237:special:dragon_warhammer_ornament"),
        ("ags", "any", "ags_special_player", "godwars_godsword_armadyl_spot",
         None, "b237:special:armadyl_godsword"),
        ("agsg", "any", "ags_special_ornate_player",
         "godwars_godsword_armadyl_spot", None,
         "b237:special:armadyl_godsword_ornate"),
        ("bgs", "any", "bgs_special_player", "godwars_godsword_bandos_spot",
         None, "b237:special:bandos_godsword"),
        ("bgsg", "any", "bgs_special_ornate_player",
         "godwars_godsword_bandos_spot", None,
         "b237:special:bandos_godsword_ornate"),
        ("sgs", "any", "sgs_special_player",
         "godwars_godsword_saradomin_spot", None,
         "b237:special:saradomin_godsword"),
        ("sgsg", "any", "sgs_special_ornate_player",
         "godwars_godsword_saradomin_spot", None,
         "b237:special:saradomin_godsword_ornate"),
        ("zgs", "any", "zgs_special_player", "godwars_godsword_zamorak_spot",
         None, "b237:special:zamorak_godsword"),
        ("zgsg", "any", "zgs_special_ornate_player",
         "godwars_godsword_zamorak_spot", None,
         "b237:special:zamorak_godsword_ornate"),
        ("ancient_godsword", "any", "ngs_special_player",
         "ngs_special_spotanim", None, "b237:special:ancient_godsword"),
        ("toxic_blowpipe_loaded", "ranged", "snakeboss_blowpipe_attack",
         "toxic_blowpipe_specialattack", None,
         "b237:special:toxic_blowpipe"),
        ("toxic_blowpipe_loaded_ornament", "ranged",
         "snakeboss_blowpipe_attack", "toxic_blowpipe_specialattack", None,
         "b237:special:toxic_blowpipe_ornament"),
        ("light_ballista", "ranged", "ballista_special_attack",
         "ballista_special", "ballista_travel", "ballista_end",
         "b237:special:light_ballista"),
        ("heavy_ballista", "ranged", "ballista_special_attack",
         "ballista_special", "ballista_travel", "ballista_end",
         "b237:special:heavy_ballista"),
        ("heavy_ballista_ornament", "ranged", "ballista02_special_attack",
         "ballista_special", "ballista_travel", "ballista_end",
         "b237:special:heavy_ballista_ornament"),
        ("xbows_crossbow_dragon", "ranged", "human_crossbow", None,
         None, "b237:special:dragon_crossbow"),
        ("acb", "ranged", "human_crossbow", "acb_specialattack",
         None, "b237:special:armadyl_crossbow"),
        ("voidwaker", "any", "human_special_voidwaker",
         "fx_voidwaker02_special", None, "fx_voidwaker_impact",
         "b237:special:voidwaker"),
        ("br_voidwaker", "any", "human_special_voidwaker",
         "fx_voidwaker02_special", None, "fx_voidwaker_impact",
         "b237:special:br_voidwaker"),
    ]
    for special in specials:
        if len(special) == 6:
            obj_name, style, attack, launch, travel, note = special
            impact = None
        else:
            obj_name, style, attack, launch, travel, impact, note = special
