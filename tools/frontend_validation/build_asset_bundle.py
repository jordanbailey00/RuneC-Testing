...
BASE_ASSETS = {
    ...
    "anims/object.anims": ROOT / "data/anims/object.anims",
...
def env_from_manifest(bundle_root: Path, manifest: dict) -> dict[str, str | int | bool]:
    ...
    env: dict[str, str | int | bool] = {
        ...
        "RUNEC_OBJECT_ANIMS": "anims/object.anims",
...
def write_env_file(path: Path, env: dict[str, str | int | bool]) -> None:
    lines = [
        "# generated by tools/frontend_validation/build_asset_bundle.py",
...
def validation_command(bundle_root: Path, manifest: dict) -> list[str]:
    ...
    cmd = [
        sys.executable,
        str(ROOT / "tools/frontend_validation/validate_combat_visuals.py"),
        "--visuals",
