...
enum {
    ...
    VIEWER_STREAMING_MAPSQUARE_SIZE = RC_MAPSQUARE_SIZE,
    VIEWER_STREAMING_MAX_MAPSQUARE_COORD = RC_MAPSQUARE_AXIS - 1,
    VIEWER_STREAMING_MAPSQUARE_CATALOG_BYTES = RC_MAPSQUARE_COUNT / 8,
};
